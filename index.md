...
Despues de la primera llamada a
[`library(censo2017)`](https://docs.ropensci.org/censo2017/) se le
pedira al usuario que descargue la base usando `censo_descargar_base()`
y se puede modificar la ruta de descarga con la variable de entorno
...
- Nombres de columna en formato “tidy” (e.g. `comuna_ref_id` en lugar de
  `COMUNA_REF_ID`).
...
variables y su etiquetado, por ejemplo como explico en la [historia del
proyecto](NA).
